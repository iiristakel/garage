  ...
  configureRouter(config: RouterConfiguration, router: Router):void {
    ...
    config.map(
      [
        ...
        { route: ['workobjects', 'workobjects/index'], name: 'workobjects' + 'Index',  moduleId: PLATFORM.moduleName('workobjects/index'), nav: true, title: 'Work objects' },
        ...
        { route: ['products', 'products/index'], name: 'products' + 'Index',  moduleId: PLATFORM.moduleName('products/index'), nav: false, title: 'Products' },
