        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    WorkerPositionValue = table.Column<string>(maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "WorkersInPositions",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    WorkerId = table.Column<int>(nullable: false),
                    WorkerPositionId = table.Column<int>(nullable: false),
                    From = table.Column<DateTime>(nullable: false),
                    Until = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkersInPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkersInPositions_Workers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "Workers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkersInPositions_WorkersPositions_WorkerPositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalSum = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkersOnObjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkersOnObjects_WorkObjects_WorkObjectId",
                        column: x => x.WorkObjectId,
                        principalTable: "WorkObjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkersOnObjects_Workers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "Workers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkersInPositions_WorkerId",
                table: "WorkersInPositions",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkersInPositions_WorkerPositionId",
                table: "WorkersInPositions",
                column: "WorkerPositionId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkersOnObjects_WorkObjectId",
                table: "WorkersOnObjects",
                column: "WorkObjectId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkersOnObjects_WorkerId",
                table: "WorkersOnObjects",
                column: "WorkerId");
