...
//                ProductsForClient = client.ProductsForClient.Select(e => ProductForClientMapper.MapFromBLL(e)).ToList()
        ...
        public static BLL.App.DTO.ClientWithProductsCount MapFromDAL(
            DAL.App.DTO.ClientWithProductsCount clientWithProductsCount)
        {
            var res = clientWithProductsCount == null
                ? null
                : new BLL.App.DTO.ClientWithProductsCount()
                {
