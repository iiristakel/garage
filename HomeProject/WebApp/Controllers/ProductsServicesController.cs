...
{
    public class ProductsServicesController : Controller
    {
        private readonly IAppBLL _bll;

        public ProductsServicesController(IAppBLL bll)
        {
            _bll = bll;
        }
        ...
        {
            var vm = new WebApp.ViewModels.ProductServiceCreateEditViewModel();
        ...
        public async Task<IActionResult> Create(WebApp.ViewModels.ProductServiceCreateEditViewModel vm)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id,
            WebApp.ViewModels.ProductServiceCreateEditViewModel vm)
        {
