...
!function (a) {
    ...
    function o(e, n) {
        var r = a(this).find("[data-valmsg-for='" + t(n[0].name) + "']"), i = r.attr("data-valmsg-replace"),
    ...
    function d(e, n) {
        var t = a(this).find("[data-valmsg-summary=true]"), r = t.find("ul");
    ...
    function s(e) {
        ...
        if (n) {
            var t = n.attr("data-valmsg-replace"), r = t ? a.parseJSON(t) : null;
            n.addClass("field-validation-valid").removeClass("field-validation-error"), e.removeData("unobtrusiveContainer"), r && n.empty()
        }
    }

    function l(e) {
        var n = a(this), t = "__jquery_unobtrusive_validation_form_reset";
        if (!n.data(t)) {
            n.data(t, !0);
            try {
    ...
    function u(e) {
        var n = a(e), t = n.data(v), r = a.proxy(l, e), i = f.unobtrusive.options || {}, u = function (n, t) {
            var r = i[n];
    ...
    return f.unobtrusive = {
        adapters: [], parseElement: function (e, n) {
            ...
            var n = a(e), t = n.parents().addBack().filter("form").add(n.find("form")).has("[data-val=true]");
        ...
        return this.add(a, [i || "min", o || "max"], function (a) {
            var i = a.params.min, o = a.params.max;
        ...
        var o = r(n.element.name), d = n.params.other, s = i(d, o),
        ...
        var d = {url: o.params.url, type: o.params.type || "GET", data: {}}, s = r(o.element.name);
